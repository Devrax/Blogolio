...
export default function PrivacyPolicy(
  { data }: PageProps<GithubUserData | null>,
) {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content={`${user?.name}'s privacy policy`} />
        <meta property="og:type" content={`${user?.name}'s blog entries`} />
        <meta property="og:url" content="https://devrafx.deno.dev/" />
        <meta
          property="og:image"
          content="https://avartation-api.vercel.app/api?face=03&outfit=10&hair=23&accessory=02&bg=rgb(30,%2041,%2059)"
        />
        <meta
          property="og:description"
          content="My privacy policy for my apps that do not collect any information"
        />
        <meta property="og:locale" content="en_US" />
      </Head>
      <main class="text-white w-[50%] mx-auto py-5">
        ...
        <h2 class="text-2xl mt-3 mb-1 text-underline">Interpretation and Definitions</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Dominican Republic
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Devrafx, accessible from{" "}
              <a
                href="https://devrafx.deno.dev/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://devrafx.deno.dev/
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 class="text-2xl mt-3 mb-1 text-underline">Collecting and Using Your Personal Data</h2>
        ...
        <h2 class="text-2xl mt-3 mb-1 text-underline">Children's Privacy</h2>
        <p>
        ...
        <h2 class="text-2xl mt-3 mb-1 text-underline">Links to Other Websites</h2>
        <p>
        ...
        <h2 class="text-2xl mt-3 mb-1 text-underline">Changes to this Privacy Policy</h2>
        <p>
        ...
        <h2 class="text-2xl mt-3 mb-1 text-underline">Contact Us</h2>
        <p>
        ...
        <ul>
          <li>
            ...
            <a
              href="https://devrafx.deno.dev/privacy-policy"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://devrafx.deno.dev/privacy-policy
            </a>
          </li>
        </ul>
      </main>
